        ...
        <div class="p-6 bg-white rounded-xl border border-gray-100 shadow-sm">
            <form action="{{ route('admin.students.index') }}" method="GET"
                ...
                <div class="flex gap-2">
                    ...
                    @endif
                    <a href="{{ route('admin.students.pdf', request()->all()) }}" target="_blank"
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-gray-50 border-b">
                        <tr>
                            ...
                            <th class="px-4 sm:px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Email</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($students as $student)
                            <tr class="hover:bg-gray-50 transition-colors text-sm">
                                ...
                                <td class="px-4 sm:px-6 py-4 hidden sm:table-cell text-gray-600">
                                    {{ $student->user->email }}
                                </td>
