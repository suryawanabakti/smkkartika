    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div class="px-4 py-3 bg-white rounded-xl border border-gray-100 shadow-sm">
            <form action="{{ route('admin.attendance.students.recap') }}" method="GET" class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('admin.attendance.students.recap.pdf', request()->all()) }}" target="_blank" class="px-4 py-1.5 bg-red-600 text-white rounded-lg text-sm font-medium hover:bg-red-700 transition-colors flex items-center gap-2">
