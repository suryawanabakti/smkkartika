...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-800">Tambah Administrator Baru</h1>
        <a href="{{ route('admin.admins.index') }}" class="text-indigo-600 hover:text-indigo-900 font-medium text-sm">
