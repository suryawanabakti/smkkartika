...
<div class="space-y-10">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Log Kehadiran Staff</h1>
            <p class="text-slate-500 font-medium mt-1">Pantau catatan kehadiran harian Anda sebagai staff.</p>
        </div>
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl sm:rounded-[2rem] border border-slate-100 shadow-sm p-6 sm:p-8 flex flex-col justify-between">
            <div>
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 class="text-base sm:text-lg font-extrabold text-slate-900">Absensi GPS Staff</h3>
    ...
    <div class="bg-white rounded-2xl sm:rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
        <div class="px-6 sm:px-8 py-4 sm:py-6 border-b border-slate-100">
            <h3 class="text-base sm:text-lg font-extrabold text-slate-900 tracking-tight">Riwayat Absensi Staff</h3>
        </div>
