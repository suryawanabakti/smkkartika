...
class AttendanceController extends Controller
{
    public function index()
    {
        ...
        return view('staff.attendance.index', compact('attendances', 'todayAttendance', 'schoolSettings', 'workHours'));
    }
    ...
    public function checkout(Request $request)
    {
        ...
        if (in_array($attendance->status, ['sick', 'permission'])) {
            return back()->with('error', 'Staff yang sedang Izin atau Sakit tidak perlu melakukan absensi pulang.');
        }
